...
export default class LoginScreen extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <Image source={require('../img/CulturEat.png')} style={styles.logo} />
        <Text style={styles.subtitle}>
          a gourment dish full of cultural stories
        </Text>
        <View
          style={{
            marginTop: 23,
        ...
        <View>{this.state.isNewUser ? <SignInForm /> : <SignUpForm />}</View>
        <Text
          style={{
            marginTop: 19,
            marginLeft: 23,
        ...
        <LoginBtn color="#e25f54" navFunc={() => navigate('Main')}>
          {this.state.isNewUser ? 'SIGN IN' : 'SIGN UP'}
        </LoginBtn>
        <View
          style={{
            width: 327,
        ...
        >
          <Divider
            styleName="line"
            style={{ height: 2, width: 142, backgroundColor: '#d6d6d6' }}
          />
        ...
        <LoginBtn color="#3d5998" navFunc={() => navigate('Main')}>
